...
export const Nyx = system("Nyx", [
	...
	station("People's Service Station ALPHA", { coordinates: { azimuthal: null, distance: null } }),
	station("People's Service Station DELTA", { coordinates: { azimuthal: null, distance: null } }),
	station("People's Service Station THETA", { coordinates: { azimuthal: null, distance: null } }),
	station("People's Service Station LAMBDA", { coordinates: { azimuthal: null, distance: null } }),
	...
	jumpPoint("Pyro Gateway", { coordinates: { azimuthal: null, distance: null } }),
	jumpPoint("Stanton Gateway", { coordinates: { azimuthal: null, distance: null } })

...
<Head title="Privacy Policy - Legal" />
...
<LegalSectionWrapper>
	<LegalSection>
		<p>
			This privacy notice for Frontier Consolidated ('we', 'us', or 'our'), describes how and why we
			might collect, store, use, and/or share ('process') your information when you use our services
			('Services'), such as when you:
		</p>
		<List tag="ul">
			<Li>
				Visit our website at frontierconsolidated.com, or any website of ours that links to this
				privacy notice
			</Li>
	...
	<LegalSection id="summary" title="Summary of key points">
		...
		<p>
			...
			you use. Learn more about <A aClass="hover:underline" href="#personal-info"
		...
		<p>
			...
			for other purposes with your consent. We process your information only when we have a valid legal
			reason to do so. Learn more about <A aClass="hover:underline" href="#processing-info"
		...
		<p>
			...
			access, steal, or modify your information. Learn more about <A
				aClass="hover:underline"
				href="#info-security">how we keep your information safe</A
			>.
		</p>
		<p>
			...
			certain rights regarding your personal information. Learn more about <A
				aClass="hover:underline"
		...
		<p>
			...
			The easiest way to exercise your rights is by visiting <A
				aClass="hover:underline"
				href="/account">frontierconsolidated.com/account</A
		...
		<p>
			Want to learn more about what we do with any information we collect? <A
				aClass="hover:underline"
				href="#table-of-contents">Review the privacy notice in full.</A
			>
		</p>
	</LegalSection>
	<LegalSection id="table-of-contents" title="TABLE OF CONTENTS">
		<List tag="ol">
			...
			<Li>
				<A aClass="hover:underline" href="#legal-bases"
					>What legal bases do we rely on to process your information?</A
				>
			</Li>
			<Li>
				<A aClass="hover:underline" href="#third-parties"
					>What is our stance on third-party websites?</A
				>
			</Li>
			<Li>
				<A aClass="hover:underline" href="#cookies"
			...
			<Li>
				<A aClass="hover:underline" href="#delete-data"
	...
	<LegalSection id="personal-info" title="1. What information do we collect?">
		...
		<List tag="ul">
			...
			<Li>Your Star Citizen username</Li>
		</List>
		<p>
		...
		<p>
			...
			We provide you with the option to register with us using your existing Discord account details.
			If you choose to register, we will collect the information described in the section called <A
				aClass="hover:underline"
				href="#social-logins">'How do we handle your social logins?'</A
			> below.
		</p>
		<p>
	...
	<LegalSection id="processing-info" title="2. How do we process your information?">
		...
		<List tag="ul">
			...
			<Li>
				...
				We may process your information when necessary to save or protect an individual’s vital interest,
	...
	>
		<p>
			<em>
				...
				with laws, to provide you with services to enter into or fulfil our contractual obligations,
				to protect your rights, or to fulfil our legitimate business interests.
			</em>
		</p>
		<p>
			<strong class="underline"
				>If you are located in the EU or UK, this section applies to you.</strong
			>
		</p>
		<p>
		...
		<List tag="ul">
			<Li>
				...
				<A aClass="hover:underline" href="#withdraw-consent">withdrawing your consent</A>.
			</Li>
			<Li>
			...
			<Li>
				...
				or the vital interests of a third party, such as situations involving potential threats to the
		...
		<p>
			...
			permission can be inferred (i.e. implied consent). You can <A
				aClass="hover:underline"
				href="#withdraw-consent">withdraw your consent</A
			> at any time.
		</p>
		<p>
	...
	<LegalSection id="third-parties" title="4. What is our stance on third-party websites?">
		<p>
			<em>
				...
				we may link to or who advertise on our Services, but are not affiliated with, our Services.
			</em>
		</p>
		<p>
			...
			collected by third parties is not covered by this privacy notice. We are not responsible for
			the content or privacy and security practices and policies of any third parties, including
			other websites, services, or applications that may be linked to or from the Services. You
	...
	<LegalSection id="cookies" title="5. Do we use cookies and other tracking technologies?">
		...
		<p>
			...
			refuse certain cookies is set out in our Cookie Policy: <A
				aClass="hover:underline"
				href="/legal/cookies">frontierconsolidated.com/legal/cookies</A
			>.
		</p>
	</LegalSection>
	<LegalSection id="social-logins" title="6. How do we handle your social logins?">
		...
		<p>
			...
			account details. Where you choose to do this, we will receive certain profile information
			about you from Discord. The profile information we receive may vary, but will often include
	...
	<LegalSection id="keeping-info" title="7. How long do we keep your information?">
		<p>
			<em>
				<strong>In Short:</strong>
				We keep your information for as long as necessary to fulfil the purposes outlined in this privacy
		...
		<p>
			...
			require us keeping your personal information for longer than the period of time in which users
	...
	<LegalSection id="privacy-rights" title="9. What are your privacy rights?">
		<p>
			<em>
				<strong>In Short:</strong>
				In some regions, such as the European Economic Area (EEA), United Kingdom (UK), Switzerland,
		...
		<p>
			...
			provided in the section <A aClass="underline" href="#contact"
		...
		<span class="text-lg font-medium text-white">Account Information</span>
		<p>
			If you would at any time like to review or change the information in your account or terminate
			your account, you can:
		</p>
		<List tag="ul">
			<Li>Log in to your account and update your user settings.</Li>
		</List>
		<p>
		...
		<p>
			...
			set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject
			cookies, this could affect certain features or services of our Services. You may also <A
				aClass="hover:underline"
				href="https://optout.aboutads.info/?c=2&lang=EN"
				>opt out of interest-based advertising by advertisers</A
			> on our Services. For further information, please see our Cookie Notice: <A
				aClass="hover:underline"
				href="/legal/cookies">frontierconsolidated.com/legal/cookies</A
			>.
		</p>
	...
	>
		<p>
			...
			information, please visit: <A aClass="hover:underline" href="/account"
				>frontierconsolidated.com/account</A
			>.
		</p>
	</LegalSection>
</LegalSectionWrapper>

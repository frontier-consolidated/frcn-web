...
const documents = {
    ...
    "\n\tquery GetCurrentUserOnServer {\n\t\tuser: getCurrentUser {\n\t\t\tid\n\t\t\tpermissions\n\t\t}\n\t}\n": types.GetCurrentUserOnServerDocument,

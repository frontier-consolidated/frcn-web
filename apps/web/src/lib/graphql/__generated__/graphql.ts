...
export type GetAllEventChannelsQuery = { __typename?: 'Query', settings: { __typename?: 'SystemSettings', defaultEventChannel?: { __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null } | null }, eventChannels: Array<{ __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null }> };

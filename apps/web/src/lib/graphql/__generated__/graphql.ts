...
export type GetEventsQuery = { __typename?: 'Query', events?: { __typename?: 'PagedEvent', page: Int['output'], nextPage?: Int['output'] | null, prevPage?: Int['output'] | null, total: Int['output'], items: Array<{ __typename?: 'Event', id: ID['output'], name: String['output'], summary: String['output'], description: String['output'], imageUrl?: String['output'] | null, eventType?: String['output'] | null, location?: Array<String['output']> | null, posted: Boolean['output'], duration?: Int['output'] | null, startAt?: Timestamp['output'] | null, endedAt?: Timestamp['output'] | null, updatedAt: Timestamp['output'], createdAt: Timestamp['output'], channel: { __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null }, owner: { __typename?: 'User', id: ID['output'], name: String['output'], discordName: String['output'], avatarUrl: String['output'], verified: Boolean['output'] }, rsvp?: { __typename?: 'EventMember', pending: Boolean['output'], rsvp: ID['output'] } | null, roles: Array<{ __typename?: 'EventRsvpRole', id: ID['output'], name: String['output'], limit: Int['output'], emoji: { __typename?: 'DiscordEmoji', id: ID['output'], name: String['output'], image?: String['output'] | null } }>, members: Array<{ __typename?: 'EventMember', id: ID['output'], pending: Boolean['output'], rsvp: ID['output'], rsvpAt: Timestamp['output'], user: { __typename?: 'User', id: ID['output'], name: String['output'], discordName: String['output'], avatarUrl: String['output'], verified: Boolean['output'], status: { __typename?: 'UserStatus', activity?: String['output'] | null, ship?: String['output'] | null } } }> }> } | null };

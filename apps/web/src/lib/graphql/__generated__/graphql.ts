...
export type GetAllEventChannelsQuery = { __typename?: 'Query', settings: { __typename?: 'SystemSettings', defaultEventChannel?: { __typename?: 'EventChannel', id: Int['output'], discord: { __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null, sendMessages: Boolean['output'] } } | null }, eventChannels: Array<{ __typename?: 'EventChannel', id: Int['output'], events: Array<{ __typename?: 'Event', id: ID['output'], name: String['output'] }>, discord: { __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null, sendMessages: Boolean['output'] } }> };

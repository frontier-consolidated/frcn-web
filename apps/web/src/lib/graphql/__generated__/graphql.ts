...
export type GetSystemSettingsQuery = { __typename?: 'Query', settings: { __typename?: 'SystemSettings', discordGuildId: String['output'], defaultEventChannel?: { __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null } | null }, eventChannels: Array<{ __typename?: 'DiscordChannel', id: ID['output'], name: String['output'], type?: String['output'] | null }> };

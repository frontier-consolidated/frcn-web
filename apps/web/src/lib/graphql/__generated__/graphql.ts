...
export type ContentContainerFragmentFragment = { __typename?: 'ContentContainer', id: ID['output'], identifier?: String['output'] | null, type: String['output'], title: String['output'], content?: String['output'] | null, files: Array<{ __typename?: 'ContentContainerFile', id: ID['output'], identifier?: String['output'] | null, fileName: String['output'], fileSizeKb: Int['output'], previewUrl?: String['output'] | null }>, children: Array<{ __typename?: 'ContentContainer', id: ID['output'], identifier?: String['output'] | null, type: String['output'], title: String['output'], content?: String['output'] | null, files: Array<{ __typename?: 'ContentContainerFile', id: ID['output'], identifier?: String['output'] | null, fileName: String['output'], fileSizeKb: Int['output'], previewUrl?: String['output'] | null }>, parent?: { __typename?: 'ContentContainer', id: ID['output'] } | null }>, parent?: { __typename?: 'ContentContainer', id: ID['output'] } | null };

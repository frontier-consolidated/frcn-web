...
<Modal
	...
	dismissable={!$missingConsent}
	outsideclose={!$missingConsent}
	open={!!$missingConsent || $cookieConsentModal}
...
>
	...
	<p>
		...
		'Manage Cookies' in the footer of any page. <A
	...
	<div class="flex flex-wrap gap-4 pt-4">
		...
		<Button
			outline
			outlineBgColor="bg-white dark:bg-gray-800"
			class="w-full md:flex-1"
			on:click={() => {
